...
(N'Phòng VIP', 45, 850, N'2 Giường đôi', N'Phòng dành cho các khách VIP.', 1, 8),
...
(N'Phòng Cao Cấp', 30, 450, N'2 Giường đôi', N'Phòng dành cho các khách hàng có tiền', 1, 12),
(N'Phòng 2 Người', 25, 350, N'1 Giường đôi', N'Thích hợp cho một cặp vợ chồng.', 1, 13),
(N'Phòng Deluxe Giường Đôi', 20, 500, N'1 Giường đôi lớn', N'This double room has air conditioning and electric kettle.', 1, 1),
(N'Phòng Gia Đình', 18, 350, N'1 Giường đơn', N'Phòng gia đình này có quầy bar mini, truyền hình cáp và máy lạnh.', 1, 14),
...
(N'Phòng Tiêu chuẩn', 15, 220, N'2 Giường đơn', N'Phòng này khá là bình thường.', 1, 8),
(N'Phòng Tiêu chuẩn', 15, 350, N'2 Giường đơn', N'Phòng này khá là bình thường.', 1, 9),
(N'Phòng Deluxe', 15, 350, N'2 Giường đơn', N'Phòng gia đình này có quầy bar mini, truyền hình cáp và máy lạnh.', 1, 10),
...
(N'Phòng Tiêu chuẩn', 15, 350, N'2 Giường đơn', N'Phòng này khá là bình thường.', 1, 13),
(N'Phòng Tiêu chuẩn', 25, 410, N'1 Giường đơn', N'Phòng này khá là bình thường.', 1, 14),
(N'Phòng Cao Cấp', 18, 350, N'1 Giường đơn', N'Phòng gia đình này có quầy bar mini, truyền hình cáp và máy lạnh.', 1, 15),
...
(N'Phòng Tiêu chuẩn', 15, 420, N'2 Giường đơn', N'Phòng này khá là bình thường.', 1, 9),
(N'Phòng Dota2', 15, 400, N'2 Giường đơn', N'Phòng này khá là chắc kèo.', 1, 10),
(N'Phòng Game', 15, 350, N'2 Giường đơn', N'This twin room has a electric kettle and air conditioning.', 1, 11),
...
(N'Phòng Trung Cấp', 18, 250, N'2 Giường đơn', N'Phòng 2 giường đơn này được trang bị ban công, áo choàng tắm cùng máy lạnh.', 1, 16),
...
(N'Phòng Trung Cấp', 4, 199, N'1 Giường đơn', N'Phòng được trang bị 2 máy tính, thích hợp để solo game.', 0, 4),
